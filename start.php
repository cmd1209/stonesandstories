    ...
    <div class="col maincontent" style="padding: 0 5px 0 0;">
        ...
        <div class="col col100 S">
          ...
          <div class="module">
            ...
            <div class="col70" style="background: url(<?php echo home_url(); ?>/wp-content/uploads/2013/11/EHM-Wand.jpg) no-repeat center center fixed;height:100%;overflow:hidden;">
              adf
            </div>
            <?php endwhile; ?>
          </div>
