...
if (function_exists('register_sidebar'))
{
    register_sidebar( array(
        'name' => __( 'Main Sidebar', 'stone' ),
        'id' => 'side',
        'description' => __( 'The main sidebar appears on the right on each page except the front page template', 'stone' ),
...
{
    global $post;
    return '... <a class="view-article" href="' . get_permalink($post->ID) . '">' . __('mehr …', 'html5blank') . '</a>';
}
...
function excerpt($limit) {
      ...
      if (count($excerpt)>=$limit) {
        array_pop($excerpt);
        $excerpt = implode(" ",$excerpt).'<a href="'. get_permalink($post->ID) . '"> mehr<strong style="margin-left:5px;">...</strong></a>';
      } else {
