        ...
        <div class="col col100 H450 S">
          ...
          <div class="module">
            ...
            <div class="col70" style="position:relative;height:100%;background-color:red;">
              <img style="position:absolute;margin-left:-50%;left:50%;height:100%!important;width:auto!important;" height="100%" width="auto" src="<?php echo home_url(); ?>/wp-content/uploads/2013/11/EHM-Wand.jpg" alt="">
            </div>
            <?php endwhile; ?>
          </div>
        </div>
