        ...
        <h1><span><?php the_title(); ?></span></h1>
          ...
          <div class="factbox" id="<?php the_title(); ?>">
            ...
            <div class="col col60" style="padding-right: 20px;">
              ...
              <div class="col100">
                <ul class="post-categories" style="overflow:hidden;"><li><?php if( get_field('factsfigures') ): ?><?php if( get_field('custom-links') ): ?> <?php the_field('custom-links'); ?><?php endif; ?><a href="#" id="factstoggle">facts & figures</a><?php endif; ?></li></ul>
              </div>     
              <div class="toggle">
